...
export function Content() {
    ...
    const [data, setData] = useState<Tourist[]>([]); // Gán data mặc định từ mockUsers
    ...
    return (
        <div className={"max-w-[100vw]"}>
            <br />
            <div>
                <h1 className=" text-lg text-center font-semibold text-lime-700 md:text-2xl">DANH SÁCH LỊCH TRÌNH</h1>
            </div>
            <br />
